...
Df['Date_freq_encode']=boxcox(Df['Date_freq_encode'],0.12)
Df['State_of_Country']=boxcox(Df['State_of_Country'],3.5)
lam=0.002
...
submissionRandom.to_csv('submissionmean.csv', index=False)
